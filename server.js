...
// const port = 3000;
const PORT = 8080;
const sequelize = require('./models/db'); // Import your database configuration
...
const requireAuth = require('./middleware/bauth.js'); // Import the basicauth middleware
...
//   // Only accessible if Basic Authentication is successful
